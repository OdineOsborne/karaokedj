...
public static class AppActions
{
    private static readonly (string Id, string Label, bool Cont, bool Hold)[] DeckTemplate =
    {
        ...
        ("volume", "Gain", true, false), ("tempo", "Tempo", true, false), ("temporeset", "Tempo 0 %", false, false),
        ...
        ("echo", "ECHO on/off", false, false), ("echoout", "ECHO OUT", false, false), ("reverb", "REVERB on/off", false, false), ("flanger", "FLANGER on/off", false, false),
