...
public static class AppActions
{
    private static readonly (string Id, string Label, bool Cont, bool Hold)[] DeckTemplate =
    {
        ...
        ("loopsize", "Loop: lunghezza (manopola)", true, false),
        ("hotcue1", "Hot cue 1", false, false), ("hotcue2", "Hot cue 2", false, false), ("hotcue3", "Hot cue 3", false, false), ("hotcue4", "Hot cue 4", false, false),
    ...
    private static readonly AppAction[] Global =
    {
        ...
        new("shift", "SHIFT della console (tieni premuto)", false, true),
